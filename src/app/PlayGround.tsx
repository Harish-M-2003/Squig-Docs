...
export default function Playground() {
  ...
  return (
    ...
    <div >
      ...
      <div className="flex mx-5 justify-center md:px-10">
      ...
      <div className="flex justify-end my-3 mx-10">
        <button
          className="hover:scale-110 active:scale-100 bg-gradient-to-tl from-blue-300 to-blue-700 p-2 px-7 text-white text-lg rounded"
      ...
      <div>
        {showOutput ? (
          <>
            ...
            <div className="bg-gray-900 mx-5 p-5 my-5">
              {output[0].error == "0" ? (
                <p className={`text-${output[0].color}-${output[0].tone} p-0 whitespace-pre-line`}>
                  {output[0].output}
                </p>
              ) : (
                <p className={`text-${output[0].color}-${output[0].tone} p-0`}>
                  {output[0].error.substring(
                    0,
                    output[0].error.indexOf(",") + 1
                  )}
                  <br />
                  {output[0].error.substring(
                    output[0].error.indexOf(",") + 1,
                    output[0].error.length
                  )}
                </p>
              )}
            </div>
